...
//        model["dts_form"] = dts
    ...
    fun searchDailyTotalForEdit(
        ...
        @RequestParam(value = "departmentName", name = "departmentName", required = false, defaultValue = "start") departmentName: String,
        model: Model
    ): String {
    ...
    @PostMapping("edit")
    fun editDailyTotal(
//        @ModelAttribute("searchDailyTotalForm") searchDailyTotalDto: SearchDailyTotalDto,
